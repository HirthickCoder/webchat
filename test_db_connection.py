...
try:
    ...
    if conn.is_connected():
        ...
        if tables:
            ...
            print("⚠️  No tables found! Run the database_setup.sql script.")
        ...
        try:
            ...
            print(f"✅ Leads table: {count} record(s)")
        except:
        ...
        try:
            ...
            count = cursor.fetchone()[0]
            print(f"✅ Chatbots table: {count} record(s)")
        except:
            print("⚠️  Chatbots table not found")
